...
root_dir = "/remote-home/zhangli/hurui/BPCH/dataset/nuswide_pre"
...
classIndexFile = os.path.join(root_dir, "Concepts81.txt")
...
output_dir = os.path.join(root_dir, "nuswide-mat") 
os.makedirs(output_dir, exist_ok=True)  

scio.savemat(os.path.join(output_dir, "index.mat"), indexs)
# scio.savemat("caption.mat", captions)
scio.savemat(os.path.join(output_dir, "label.mat"), labels)
